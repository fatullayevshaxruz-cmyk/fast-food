...
async def seed_data():
    ...
    products = [
        ...
        (7,  2, "Tovuqli Lavash",      "Tovuq go'shti, chips, yangi sabzavotlar, garmdori sousi.",         28000, "https://images.unsplash.com/photo-1600891964092-4316c288032e?w=500"),
        (8,  2, "Mini Lavash",         "Kichikroq porsiya, ammo to'yimli va mazali.",                      22000, "https://images.unsplash.com/photo-1600891964599-f61ba0e24092?w=500"),
        (9,  2, "XL Lavash",           "Katta porsiya mol go'shti lavash, ikki marta to'yimli.",           40000, "https://images.unsplash.com/photo-1585238341710-4d3ff484184d?w=500"),
        ...
        (19, 4, "Milkshake",          "Muzqaymoqli sut kokteyli — shokolad, vanil yoki qulupnay.",        18000, "https://images.unsplash.com/photo-1579954115545-a95591f28bfc?w=500"),
        (20, 4, "Suv 0.5L",           "Gazsiz toza ichimlik suvi.",                                        3000, "https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=500"),

        # ── Hot-doglar (cat 5) ─────────────────────────────────────────────────
        (21, 5, "Classic Hot-dog",    "Sosiska, ketchup, xantal, non ichida.",                             15000, "https://images.unsplash.com/photo-1619740455993-9e612b1af08a?w=500"),
        ...
        # ── Gazaklar (cat 6) ───────────────────────────────────────────────────
        (24, 6, "Kartoshka Fri",      "Qovurilgan kartoshka, ketchup yoki sous bilan.",                    12000, "https://images.unsplash.com/photo-1630384060421-cb20d0e0649d?w=500"),
        ...
        (27, 6, "Ketchup sousi",      "Qo'shimcha ketchup sousi (100ml).",                                  3000, "https://images.unsplash.com/photo-1461009683693-342af2f2d6ce?w=500"),

        # ── Donerlar (cat 7) ───────────────────────────────────────────────────
        (28, 7, "Toviuqli Doner",     "Grillda pishirilgan tovuq go'shti, sabzavot, yogurt sousi.",        32000, "https://images.unsplash.com/photo-1530469912745-a215c6b256ea?w=500"),
        (29, 7, "Mol go'shtli Doner", "Mol go'shti, lavash, pomidor, bodring, garmdori sousi.",            35000, "https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=500"),
        (30, 7, "Mix Doner",          "Tovuq + mol go'shti aralash, barcha sous va sabzavotlar.",          40000, "https://images.unsplash.com/photo-1529006557810-274b9b2fc783?w=500"),

        # ── KFC / Tovuqlar (cat 8) ─────────────────────────────────────────────
        (31, 8, "Qovurilgan Tovuq",   "KFC uslubida qovurilgan tovuq bo'lagi (2 dona).",                   28000, "https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=500"),
        ...
        (33, 8, "Chicken Strips",     "Krustonli tovuq po'stloqli tasmalar, ranch sousi bilan.",            25000, "https://images.unsplash.com/photo-1619881590738-a111d176d906?w=500"),
        (34, 8, "Spicy Chicken",      "Achchiq ziravorlarda marinlangan qovurilgan tovuq.",                 32000, "https://images.unsplash.com/photo-1606755456206-b25206cde27e?w=500"),
        ...
        (36, 9, "Oilaviy Kombo",      "2ta Burger + 2ta Kartoshka + 2ta Ichimlik.",                        85000, "https://images.unsplash.com/photo-1550547660-d9450f859349?w=500"),
